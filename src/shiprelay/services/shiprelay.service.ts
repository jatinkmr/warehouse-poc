...
export class ShipRelayService {
    ...
    async shipmentRateCalculationService(reqBody: ShipmentRateDto): Promise<IShipmentRateModel> {
        return await this.shipLibService.shipmentRateLibService(reqBody);
    }
}
